...
class Slider extends React.Component {
	...
	slide(event) {
		...
		const allSliderButtonNodes = sliderNode.children;
		let sliderNodeWidth = 0;

		for (const el of allSliderButtonNodes) {
			sliderNodeWidth += parseInt(getComputedStyle(el).width, 10) + 15;
		}
		sliderNodeWidth += 5;
